...
$correos='ventas@camarasdeseguridadmexico.com,noelbasurto9@gmail.com,basurtoomar@gmail.com';
...
else
{
	...
	<h1 style="color:#06F;" class="tex">Cámaras de Seguridad México</h1> 
	<p> 
	<b style="color:#06F;" class="tex">Buen dia tienes un correo electrónico de camarasdeseguridadmexico.com</b>. </p>
	<p style="color:#06F;" class="tex">Los Datos del Contacto Aparecen en seguida contactalo.. </p>
	<table width="600"  align="center" class="tex" >	 	  
	  <tr>
	    <td>Nombre:</td>
	    <td>'.$nombre.'</td>
	  </tr>
	...
	$headers .= "From: camarasdeseguridadmexico  <info@camarasdeseguridadmexico.com> \r\n"; 
